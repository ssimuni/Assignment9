        ...
        <div>
            <Card className="w-full lg:max-w-[26rem] shadow-lg mb-5">
                <CardHeader floated={false} color="blue-gray">
                    <span className="absolute left-0 top-0 z-10 ml-3 mt-3 inline-flex select-none rounded-lg bg-black px-3 py-2 text-sm font-bold text-white "> {status} </span>
                    <img
                ...
                <CardBody>
                    <div className="mb-3 flex items-center justify-between">
                        ...
                        <Typography
                            className="flex items-center gap-1.5 font-bold ml-5"
                        >
                            {price}
                        </Typography>
                    </div>
                    <Typography color="gray" className='font-semibold mb-2'>
                        <svg className="mr-3 inline-block h-5 w-5 fill-current  xl:h-4 xl:w-4" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <CardFooter className="pt-3">
                    <Link className='btn bg-black text-white w-full' to={`/estates/${id}`} >
                        View Property
                    </Link>
                </CardFooter>
            </Card>
